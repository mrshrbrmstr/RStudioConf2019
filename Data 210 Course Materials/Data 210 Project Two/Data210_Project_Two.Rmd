...
First, just start with a few simple histograms (use ggplot with geom_histogram and also geom_freqpoly for the carat data) of the variable carat. Repeat for the variable price (this time use geom_freqpoly); also for the variable price. You should experiment with different values before settling on a final version of each of the 3 plots.
